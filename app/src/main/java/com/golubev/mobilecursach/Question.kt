...
class Question : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.timer = object: CountDownTimer(540000L, 1000) {
        ...
        selectedYes.setOnClickListener {
            ...
            selectedNo.background =  getResources().getDrawable(R.drawable.purpuler11)
            selectedAnswer = true;
        ...
        selectedNo.setOnClickListener {
            selectedYes.background =  getResources().getDrawable(R.drawable.purpuler11)
